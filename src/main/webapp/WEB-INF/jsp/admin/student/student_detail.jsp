...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" ${empty n.id ? '' : 'readonly' } id="studentNumber" name="studentNumber" value="${n.studentNumber}">
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" id="nativePlace" name="nativePlace" value="${n.nativePlace}">
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" ${empty n.id ? '' : 'readonly' } id="myClass" name="myClass" value="${n.myClass}">
        </div>
